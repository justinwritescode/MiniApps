...
namespace 
{
  ...
  partial class ThisAssembly
  {
    ...
    public partial class Git
    {
      ...
      /// <summary>Repository URL: https://github.com/justinwritescode/justinwritescode.git</summary>
      public const string RepositoryUrl = @"https://github.com/justinwritescode/justinwritescode.git";

      /// <summary>Branch: main</summary>
      public const string Branch = @"main";

      /// <summary>Commit: ec8cf3c</summary>
      public const string Commit = @"ec8cf3c";

      /// <summary>Sha: ec8cf3cc264829fac1805f5f1cc4dda565210b97</summary>
      public const string Sha = @"ec8cf3cc264829fac1805f5f1cc4dda565210b97";

      /// <summary>Commit date: 2023-01-20T17:14:47-05:00</summary>
      public const string CommitDate = @"2023-01-20T17:14:47-05:00";

      /// <summary>Commits on top of base version: 224</summary>
      public const string Commits = @"224";

      /// <summary>Tag: v0.0.1-224-gec8cf3c</summary>
      public const string Tag = @"v0.0.1-224-gec8cf3c";
      ...
      public partial class SemVer
      {
        ...
        /// <summary>Patch: 225</summary>
        public const string Patch = @"225";
